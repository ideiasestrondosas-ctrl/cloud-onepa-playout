    ...
    match result {
        ...
        Ok(None) => {
            ...
            HttpResponse::Ok().json(Settings {
                ...
                system_version: Some("v2.2.0-ALPHA.28-PRO".to_string()),
                ...
                rtsp_output_url: Some("rtsp://localhost:8554/live_stream".to_string()),
                webrtc_output_url: Some("http://localhost:8889/live_stream".to_string()),
...
async fn reset_all(pool: web::Data<PgPool>) -> impl Responder {
    ...
    let reset_sql = format!(
        "UPDATE settings SET 
        output_type = 'rtmp', 
        output_url = 'rtmp://{}:1935/live_stream', 
        ...
        rtmp_output_url = 'rtmp://{}:1935/live_stream',
        srt_output_url = 'srt://{}:8890?mode=caller&streamid=publish:live_stream_srt',
